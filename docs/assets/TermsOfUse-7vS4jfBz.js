import{ao as i,ak as e}from"./index-CvhaT9ii.js";import{b as o}from"./emergency-Bkead6oY.js";const n=[{id:"responsibilities",icon:"👤",accent:"#2ECC8F",accentRgb:"46,204,143",key:"responsibilities",clauses:["accurate","appropriate","security"]},{id:"privacy",icon:"🔒",accent:"#5B8DEF",accentRgb:"91,141,239",key:"privacy",clauses:["collect","retention","thirdParty"]},{id:"ra10175",icon:"📜",accent:"#F5C842",accentRgb:"245,200,66",key:"ra10175",clauses:["act","prohibited","reporting"]},{id:"disclaimer",icon:"⚠️",accent:"#EF5B5B",accentRgb:"239,91,91",key:"disclaimer",clauses:["noGuarantee","availability","accuracy"]}];function p(){const{t,isRTL:r}=i();return e.jsxs(e.Fragment,{children:[e.jsx("style",{children:`
      ...
      `}),e.jsxs("div",{className:"tos",dir:r?"rtl":"ltr",children:[e.jsxs("div",{className:"tos-bg",children:[e.jsx("img",{src:o,alt:"",className:"tos-bg-img","aria-hidden":"true"}),e.jsx("div",{className:"tos-bg-overlay"}),e.jsx("div",{className:"tos-bg-atmosphere"}),e.jsx("div",{className:"tos-bg-grain"})]}),e.jsxs("div",{className:"tos-wrap",children:[e.jsxs("section",{className:"tos-hero",children:[e.jsx("div",{className:"tos-hero-eyebrow",children:t("terms.eyebrow")}),e.jsxs("h1",{children:[t("terms.titleLine1")," ",e.jsx("span",{className:"accent",children:t("terms.titleAccent")})]}),e.jsx("p",{className:"tos-hero-sub",children:t("terms.sub")}),e.jsxs("div",{className:"tos-meta",children:[e.jsx("span",{className:"tos-meta-dot"}),t("terms.meta")]})]}),e.jsxs("div",{className:"tos-section",children:[e.jsx("div",{className:"tos-label",children:t("terms.sectionsLabel")}),e.jsx("div",{className:"tos-section-list",children:n.map(a=>e.jsxs("div",{id:a.id,className:"tos-card",style:{"--s-accent":a.accent,"--s-dim":`rgba(${a.accentRgb},0.10)`},children:[e.jsxs("div",{className:"tos-card-top",children:[e.jsx("span",{className:"tos-card-icon",children:a.icon}),e.jsx("span",{className:"tos-card-tag",children:t(`terms.sections.${a.key}.tag`)})]}),e.jsx("div",{className:"tos-card-title",children:t(`terms.sections.${a.key}.title`)}),e.jsx("div",{className:"tos-clauses",children:a.clauses.map(s=>e.jsxs("div",{children:[e.jsx("div",{className:"tos-clause-heading",children:t(`terms.sections.${a.key}.${s}.heading`)}),e.jsx("p",{className:"tos-clause-body",children:t(`terms.sections.${a.key}.${s}.body`)})]},s))})]},a.id))})]}),e.jsx("div",{className:"tos-section",children:e.jsxs("div",{className:"tos-cta",children:[e.jsxs("div",{className:"tos-cta-text",children:[e.jsx("h3",{children:t("terms.ctaHeading")}),e.jsx("p",{children:t("terms.ctaSub")})]}),e.jsxs("a",{href:"/report",className:"tos-cta-btn",children:["🚨 ",t("terms.ctaBtn")]})]})})]})]})]})}export{p as default};
