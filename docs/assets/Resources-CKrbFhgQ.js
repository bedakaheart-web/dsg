import{ao as i,ak as e,ae as t}from"./index-CvhaT9ii.js";import{b as o}from"./emergency-Bkead6oY.js";const n=[{id:"safety",icon:"🛡️",accent:"#2ECC8F",key:"safety",links:[{key:"before",to:"/safetytips#typhoon"},{key:"flood",to:"/safetytips#flood"},{key:"fire",to:"/safetytips#fire"}]},{id:"agencies",icon:"🤝",accent:"#4A90D9",key:"agencies",links:[{key:"cdrrmo",to:"/partner-agencies#cdrrmo"},{key:"redcross",to:"/partner-agencies#redcross"},{key:"bfp",to:"/partner-agencies#bfp"}]},{id:"directory",icon:"📋",accent:"#F5C842",key:"directory",links:[{key:"city",to:"/directory#city"},{key:"barangays",to:"/directory#barangays"},{key:"hospitals",to:"/directory#hospitals"}]},{id:"terms",icon:"📜",accent:"#e8372a",key:"terms",links:[{key:"responsibilities",to:"/terms#responsibilities"},{key:"privacy",to:"/terms#privacy"},{key:"ra10175",to:"/terms#ra10175"}]}];function l(){const{t:r}=i();return e.jsxs(e.Fragment,{children:[e.jsx("style",{children:`
      ...
      `}),e.jsxs("div",{className:"rs",children:[e.jsxs("div",{className:"rs-bg",children:[e.jsx("img",{src:o,alt:"",className:"rs-bg-img","aria-hidden":"true"}),e.jsx("div",{className:"rs-bg-overlay"}),e.jsx("div",{className:"rs-bg-atmosphere"}),e.jsx("div",{className:"rs-bg-grain"})]}),e.jsxs("div",{className:"rs-wrap",children:[e.jsxs("section",{className:"rs-hero",children:[e.jsxs("h1",{children:[r("resources.heroTitle")," ",e.jsx("span",{className:"accent",children:r("resources.heroAccent")})]}),e.jsx("p",{className:"rs-hero-sub",children:r("resources.heroSub")})]}),e.jsx("div",{className:"rs-grid",children:n.map(a=>e.jsxs("div",{className:"rs-card",style:{"--rs-accent":a.accent,"--rs-alpha":`${a.accent}18`,"--rs-accent-border":`${a.accent}40`},children:[e.jsxs("div",{className:"rs-card-top",children:[e.jsx("span",{className:"rs-icon",children:a.icon}),e.jsx("span",{className:"rs-tag",children:r(`resources.cards.${a.key}.tag`)})]}),e.jsx("div",{className:"rs-card-title",children:r(`resources.cards.${a.key}.title`)}),e.jsx("p",{className:"rs-card-desc",children:r(`resources.cards.${a.key}.description`)}),e.jsx("div",{className:"rs-divider"}),e.jsx("div",{className:"rs-links",children:a.links.map(s=>e.jsxs(t,{to:s.to,className:"rs-link",children:[e.jsx("span",{children:r(`resources.cards.${a.key}.links.${s.key}`)}),e.jsx("span",{className:"rs-link-arrow",children:"→"})]},s.key))})]},a.id))}),e.jsxs("div",{className:"rs-cta",children:[e.jsxs("div",{className:"rs-cta-text",children:[e.jsx("h3",{children:r("resources.cta.title")}),e.jsx("p",{children:r("resources.cta.desc")})]}),e.jsxs(t,{to:"/report",className:"rs-cta-btn",children:[e.jsx("span",{children:"🚨"})," ",r("resources.cta.btn")]})]})]})]})]})}export{l as default};
