...
add_keys = """      backToDashboard: "Back to Dashboard",
      ...
      form: {
        ...
        legalCheckText: "I confirm that the information I am providing is true and accurate to the best of your knowledge.",
        submitBtn: "Submit Incident Report", submitting: "Submitting…",
      },"""

inserted = 0
# Process in reverse order so positions don't shift
for report_start in reversed(report_starts):
