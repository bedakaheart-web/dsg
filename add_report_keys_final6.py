...
# Keys to add (English as fallback)
...
for m in reversed(matches):
    ...
    # Look backwards 3000 chars to find the report block start
    before = content[max(0, pos - 3000):pos]
    
    # Check if this is inside a report data block (has heroTitle: "...")
    if 'heroTitle: "' not in before:
        continue
    
    # Check if backToDashboard already exists before this position
