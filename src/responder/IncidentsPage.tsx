...
.ri { color: var(--text-primary); background: var(--bg-primary); font-size: 14px; line-height: 1.5; }
...
.ri-card:nth-child(3) { animation-delay: 0.1s; }
...
.ri-card-top { display: flex; align-items: center; justify-content: space-between; gap: 10px; margin-bottom: 14px; flex-wrap: wrap; }
.ri-card-label { display: flex; align-items: center; gap: 8px; font-size: 13px; font-weight: 700; }
...
/* Status badge */
.ri-badge { font-size: 9px; font-weight: 700; padding: 4px 10px; border-radius: 6px; white-space: nowrap; border: 1px solid; }
...
/* Fields */
.ri-fields { display: grid; grid-template-columns: 1fr 1fr; gap: 10px; margin-bottom: 14px; }
.ri-field { padding: 10px 12px; background: var(--bg-secondary); border: 1px solid var(--border-light); border-radius: 10px; display: flex; flex-direction: column; gap: 3px; }
.ri-field-lbl { font-size: 9px; font-weight: 600; color: var(--text-secondary); letter-spacing: 0.3px; text-transform: uppercase; display: flex; align-items: center; gap: 4px; }
...
.ri-desc { font-size: 12px; font-weight: 400; color: var(--text-secondary); line-height: 1.6; padding: 11px 13px; background: var(--bg-secondary); border: 1px solid var(--border-light); border-radius: 10px; margin-bottom: 12px; }
...
.ri-btn { display: inline-flex; align-items: center; gap: 6px; font-size: 10px; font-weight: 700; padding: 7px 14px; border-radius: 8px; cursor: pointer; border: 1px solid; transition: all 0.2s; text-decoration: none; letter-spacing: 0.3px; text-transform: uppercase; }
...
.ri-btn-claim:hover:not(:disabled) { background: rgba(220, 38, 38, 0.15); border-color: var(--danger-light); }
.ri-btn-resolve { background: var(--success-bg); border-color: var(--success-light); color: var(--success-light); }
.ri-btn-resolve:hover:not(:disabled) { background: rgba(11, 102, 35, 0.15); border-color: var(--success-light); }
.ri-btn-nav     { background: var(--info-bg); border-color: var(--primary); color: var(--primary); }
.ri-btn-nav:hover:not(:disabled) { background: rgba(0, 82, 204, 0.15); border-color: var(--primary); }
...
.ri-modal-icon { width: 40px; height: 40px; border-radius: 10px; flex-shrink: 0; background: linear-gradient(135deg, var(--success) 0%, var(--success-light) 100%); border: none; display: flex; align-items: center; justify-content: center; color: white; }
...
.ri-modal-close:hover { background: var(--bg-secondary); color: var(--text-primary); border-color: var(--border-med); }
...
.ri-sum-type { font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif; font-weight: 800; font-size: 12px; text-transform: uppercase; }
...
.ri-step { font-size: 9px; font-weight: 700; color: white; background: linear-gradient(135deg, var(--primary) 0%, #0052CC 100%); border: none; border-radius: 5px; padding: 4px 8px; flex-shrink: 0; }
...
.ri-rt-radio { width: 16px; height: 16px; border-radius: 50%; border: 2px solid var(--border-light); flex-shrink: 0; transition: all 0.2s; position: relative; }
.ri-rt-card.sel .ri-rt-radio { border-color: var(--primary); background: var(--primary); }

/* Textarea */
.ri-textarea { width: 100%; min-height: 100px; resize: vertical; background: var(--surface); border: 1px solid var(--border-light); border-radius: 10px; padding: 12px 14px; font-size: 13px; font-weight: 400; color: var(--text-primary); outline: none; line-height: 1.6; transition: all 0.2s; caret-color: var(--primary); }
...
.ri-ag-card:hover { background: var(--surface); transform: translateY(-1px); border-left-color: var(--primary); }
    ...
    <div className="ri-modal-bg" onClick={onCancel}>
      <div className="ri-modal" onClick={(e) => e.stopPropagation()}>
        ...
        <div className="ri-modal-body">
          ...
          <div className={cls("ri-sum", tm.colorClass)}>
            <div className="ri-sum-row">
              <span className="ri-sum-lbl">Type</span>
          ...
          <textarea
            ...
            placeholder="Describe situation upon arrival, severity, conditions observed…"
            value={notes}
          ...
          <textarea
            ...
            placeholder="e.g. Deployed BFP units, fire extinguished at 14:32 — area secured…"
            value={actionTaken}
          ...
          <div className="ri-ag-sec">
            <div className="ri-ag-hd">
              <span className="ri-ag-lbl">Recommended Agencies</span>
        ...
        <div className="ri-modal-ft">
          ...
          <button
            className={cls("ri-ft-confirm", selectedRT ? selectedRT.colorClass : "rt-green")}
            onClick={handleConfirm}
            disabled={submitting}
          >
            {submitting
              ? <><span className="ri-spinner-sm" /> SUBMITTING…</>
              : <><SvgIcon path={ICONS.check} size={14} /> SUBMIT &amp; RESOLVE</>
            }
          </button>
        </div>
      </div>
                      ...
                      <div className="ri-ev-wrap">
                        ...
                        <div className="ri-ev-bar">
                          ...
                          <a href={r.evidence_url} target="_blank" rel="noopener noreferrer" className="ri-ev-link">
                            Open <SvgIcon path={ICONS.externalLink} size={10} />
                          </a>
                        </div>
                      </div>
                    )}
