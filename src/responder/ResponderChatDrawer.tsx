...
function playPing() {
  try {
    ...
    // Audio unavailable (e.g. autoplay policy) G�� badge still alerts visually.
  }
}
    ...
    <div style={{ display: "flex", justifyContent: mine ? "flex-end" : "flex-start", marginBottom: 8 }}>
      ...
      >
        ...
        <div style={{ fontSize: 9, opacity: 0.5, marginTop: 3, textAlign: "right" }}>
          {failed ? "sendingGǪ" : fmtTime(m.created_at)}
        </div>
      </div>
    </div>
  );
...
export default function ResponderChatDrawer({ responderId, open, onClose, targetId = null, targetName = null, responderName = "Responder" }: {
  ...
  // G��G�� Calling (responder G�� admin HQ) G�� WebRTC + TURN (unified with AdminChatDrawer & ChatBox) G��G��
  ...
  // G��G�� HQ admin list G��G��G��G��G��G��G��G��G��G��G��G��G��G��G��G��G��G��G��G��G��G��G��G��G��G��G��G��G��G��G��G��G��G��G��G��G��G��G��G��G��G��G��G��G��G��G��G��G��G��G��G��G��G��G��G��
  useEffect(() => {
    const load = async () => {
  ...
  // G��G�� Unread badges G��G��G��G��G��G��G��G��G��G��G��G��G��G��G��G��G��G��G��G��G��G��G��G��G��G��G��G��G��G��G��G��G��G��G��G��G��G��G��G��G��G��G��G��G��G��G��G��G��G��G��G��G��G��G��G��
  ...
  // G��G�� Open thread G�� mark read + refresh G��G��G��G��G��G��G��G��G��G��G��G��G��G��G��G��G��G��G��G��G��G��G��G��G��G��G��G��G��G��G��G��G��G��G��G��
  ...
  // G��G�� Auto-scroll to bottom on every new message G��G��G��G��G��G��G��G��G��G��G��G��G��G��G��G��G��G��G��G��G��G��G��G��G��G��
  useEffect(() => {
            ...
            <>
              ...
              <div style={{ padding: "8px 12px", borderBottom: "1px solid rgba(255,255,255,0.06)", display: "flex", alignItems: "center", gap: 8 }}>
                <button onClick={() => (broadcastMode ? onClose() : setActiveId(null))}
                  style={{ background: "none", border: "none", color: "#2ECC8F", cursor: "pointer", fontSize: 14 }}>G��</button>
              ...
              <div style={{ flex: 1, overflowY: "auto", padding: "12px" }}>
                {loading ? (
                  <div style={{ fontSize: 12, color: "rgba(238,240,247,0.4)", textAlign: "center", padding: 20 }}>LoadingGǪ</div>
                ) : messages.length === 0 ? (
              ...
              {/* Composer (1-on-1 only G�� broadcasts are HQ announcements) */}
              {!broadcastMode ? (
                ...
                <div style={{ padding: 10, borderTop: "1px solid rgba(255,255,255,0.08)", fontSize: 11, color: "rgba(238,240,247,0.4)", textAlign: "center" }}>
                  Broadcasts are HQ announcements G�� reply via direct HQ chat.
                </div>
              )}
            </>
          )}
        {/* Call Overlay G�� responderG��admin via WebRTC + TURN */}
