...
export default function SafetyTips() {
  ...
  const PHASE_META = {
    before: { label: t("safetyTips.phases.beforeLabel"), icon: "⚡", desc: t("safetyTips.phases.beforeDesc") },
    during: { label: t("safetyTips.phases.duringLabel"), icon: "🔴", desc: t("safetyTips.phases.duringDesc") },
    after:  { label: t("safetyTips.phases.afterLabel"),  icon: "✅", desc: t("safetyTips.phases.afterDesc") },
  };
